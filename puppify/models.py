...
#     idimage = models.ForeignKey(Image, db_column='idimage', blank=True, null=True, on_delete=models.CASCADE)
...
#     idpersonne = models.OneToOneField(Personne, db_column='idpersonne', primary_key=True,on_delete=models.CASCADE)
#     isformaccepted = models.BooleanField(default=0, null=True)
#     isformfilled = models.BooleanField(default=0, null=True)
#
#
#     class Meta:
#         managed = False
...
class Chat(models.Model):
    idanimal = models.OneToOneField(Animal, models.CASCADE, db_column='idanimal', primary_key=True)
    racechat = models.CharField(max_length=25, blank=True, null=True)
...
class Favoris(models.Model):
    idpersonne = models.OneToOneField('Personne', models.CASCADE, db_column='idpersonne', primary_key=True)
    idanimal = models.ForeignKey(Animal, models.CASCADE, db_column='idanimal')
...
class Formulaire(models.Model):
    ...
    libelle_form = models.CharField(max_length=200,blank=True, null=True)
...
class Question(models.Model):
    ...
    libelle_question = models.CharField(max_length=200,blank=True, null=True)
    ...
    def __str__(self):
        return '%s' % (self.libelle_question)
